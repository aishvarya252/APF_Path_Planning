...
if __name__ == "__main__":
    ...
    L = 4.8
    B = 1.8
    #Places static and moving vehicles on the map: vehicles: Stationary vehicles.
    #moving_vehicles: Vehicles that move dynamically during the simulation.
    ...
    #Vehicle orientation (fi). Front velocity in a given direction (vf).
    ...
    #Verifies consistency in vehicle positioning using difference.
    ...
    #Plots the vehicle and moving vehicles on the map.
